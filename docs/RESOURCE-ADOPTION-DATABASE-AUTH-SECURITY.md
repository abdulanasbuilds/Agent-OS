...
| Cloudflare Security Audit Skill | **ADOPT METHODOLOGY** | Strong exploitability bar and independent validation. Avoid importing its automation/toolchain as a trusted executable dependency. |
